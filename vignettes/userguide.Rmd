...
and make sure `clustermq` runs there without problems. Note that the *remote
scheduler* can not be `LOCAL` or `SSH` for this to work.

```{r eval=FALSE}
# If this is set to 'SSH' or 'LOCAL' (default) you will get the following error:
